...
This draft is kind of a failure, or at least not yet a success: the first half of the lyric, which I’ve translated here, works well enough, but the second half is a lot denser, and I think the footnotes would probably outweigh the payoff. <sup class="mn-marker" data-mn-id="mn-1" aria-controls="mn-1" aria-expanded="false" title="Toggle note">※</sup> Can’t win them all, I guess.
